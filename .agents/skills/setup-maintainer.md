...
- **CRITICAL MAINTENANCE MANDATE:** Whenever any skill template under `template/skills/` is modified, you MUST immediately update or write its corresponding human-readable documentation under `docs/skills/` to ensure absolute synchronization prior to committing or pushing.
